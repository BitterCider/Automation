...
import { checkoutComplete, itemsToCart, itemTitleLink, thankYouText, orderDispatch } from "./Variables";
...
export async function assertCartBadge(page, cartBadge){
  await expect(page.locator(cartBadge)).toContainText(itemsToCart.length.toString());
}

export async function assertCartQuantity(page, cartIcon, itemLocator, itemList){
