...
export const itemTitleLink =[{Link: '[data-test="item-4-title-link"]', Title: "Sauce Labs Backpack"},
   {Link: '[data-test="item-5-title-link"]', Title: 'Sauce Labs Fleece Jacket'}];
export const cartBadge = '[data-test="shopping-cart-badge"]';
export const itemsToCart = ["#add-to-cart-sauce-labs-backpack", "#add-to-cart-sauce-labs-fleece-jacket"];
export const cartIconLink = '[data-test="shopping-cart-link"]';
export const quantityElement = '[data-test="item-quantity"]';

//Login parameters:
export const deliveryInfo = [{firstName: "tal", lastName: "baruchi", postalCode:"2220325"}]
